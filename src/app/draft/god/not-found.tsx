...
export default function GodDraftNotFound() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#05070d] px-4">
      <div className="max-w-md text-center">
        <p className="mb-2 text-[0.65rem] font-black uppercase tracking-widest text-cyan-300/60">God Draft</p>
        <h1 className="mb-4 text-3xl font-black text-white">Session Not Found</h1>
        <p className="mb-8 text-sm font-semibold text-slate-400">
          This god draft session doesn&apos;t exist or has already ended. Ask an admin for a fresh link.
        </p>
        <Link
          href="/schedule"
