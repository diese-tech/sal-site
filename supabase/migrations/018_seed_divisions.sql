...
-- hardcoded union "gaia" | "solar" | "lunar" and orgs/matches/draft_rooms all
...
INSERT INTO divisions (id, name, description, tier, accent_color) VALUES
  ('gaia',  'Gaia Division',  'Top-tier competitive play. The pinnacle where champions are forged.', 1, 'emerald'),
